...
def evolutionary_algorith(start_size: int, circuit: Circuit, max_iter: int, parents_percentage: int, selection_type: str,cross_type : int,cross_prob : float,mutation_aggr: bool,mutation_prob1: float,mutation_comp: bool,mutation_prob2: float,mutation_pit: bool,mutation_prob3: float):
    """
